...
export class GlobalAuthenticationComponent implements OnInit {
  ...
  // Local storage keys
  private readonly AUTH_TYPE_KEY = 'kraven_auth_type';
  private readonly API_KEY_AUTH_KEY = 'kraven_api_key';
  private readonly BEARER_AUTH_KEY = 'kraven_bearer_token';
  private readonly BASIC_AUTH_USERNAME_KEY = 'kraven_basic_auth_username';
  private readonly BASIC_AUTH_PASSWORD_KEY = 'kraven_basic_auth_password';
