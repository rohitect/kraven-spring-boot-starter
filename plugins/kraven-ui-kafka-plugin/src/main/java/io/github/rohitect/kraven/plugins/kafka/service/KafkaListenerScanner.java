...
import io.github.rohitect.kraven.plugins.kafka.model.KafkaListener;
...
public class KafkaListenerScanner implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public KafkaListenerScanner(ApplicationContext applicationContext, KafkaPluginConfig config) {
        this.applicationContext = applicationContext;
        this.config = config;
        log.info("KafkaListenerScanner initialized");
    }
