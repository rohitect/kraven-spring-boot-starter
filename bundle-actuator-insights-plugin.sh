...
# Script to build and bundle the Actuator Insights plugin for Maven Central deployment
...
echo "Building Actuator Insights plugin bundle version: $VERSION"
...
BUNDLE_DIR="dist/plugins/actuator-insights"
MAVEN_BUNDLE_DIR="dist/maven-bundles"
mkdir -p $BUNDLE_DIR
mkdir -p $MAVEN_BUNDLE_DIR

# Copy plugin JAR to bundle directory
echo "Copying Actuator Insights plugin JAR to bundle directory..."
cp plugins/kraven-ui-actuator-insights-plugin/target/kraven-ui-actuator-insights-plugin-*-jar-with-dependencies.jar $BUNDLE_DIR/
...
ARTIFACT_BASE="kraven-ui-actuator-insights-plugin"
...
cp plugins/kraven-ui-actuator-insights-plugin/target/kraven-ui-actuator-insights-plugin-*-jar-with-dependencies.jar \
   $MAVEN_BUNDLE_TMP/$GROUP_PATH/$ARTIFACT_ID/$VERSION/$ARTIFACT_ID-$VERSION.jar

# Copy POM file
cp plugins/kraven-ui-actuator-insights-plugin/pom.xml \
...
echo "Actuator Insights plugin bundle created successfully:"
