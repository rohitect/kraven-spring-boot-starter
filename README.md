...
![Kraven UI Screenshot](docs/kraven-ui-screenshot.png)
...
Start your Spring Boot application and navigate to the configured path (e.g., `http://localhost:8080/kraven`) to see your API documentation with Kraven UI.
